import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/user/Desktop/study/nuxt-3/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getQuery as getQuery$1, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unctx/dist/index.mjs';
import { extname } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unified/index.js';
import { toString } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/slugify/slugify.js';
import remarkParse from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/remark-mdc/dist/index.mjs';
import { toString as toString$1 } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/github-slugger/index.js';
import { detab } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/detab/index.js';
import remarkEmoji from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/rehype-raw/index.js';
import { version, unref } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/user/Desktop/study/nuxt-3/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/user/Desktop/study/nuxt-3/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/user/Desktop/study/nuxt-3/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/user/Desktop/study/nuxt-3/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/user/Desktop/study/nuxt-3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/user/Desktop/study/nuxt-3/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/user/Desktop/study/nuxt-3/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/user/Desktop/study/nuxt-3/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/user/Desktop/study/nuxt-3/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _y7Ae8tYFUu = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/user/Desktop/study/nuxt-3";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _VliJQcEeiI = (nitroApp) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/user/Desktop/study/nuxt-3/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _wXEObR = defineEventHandler(async (event) => {
...
const _5dVBjO = defineEventHandler(async (event) => {
...
const _DiO9Sf = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_uQg7EV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_uQg7EV, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _wXEObR, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _wXEObR, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _wXEObR, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _5dVBjO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _DiO9Sf, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _DiO9Sf, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _DiO9Sf, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_uQg7EV, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/user/Desktop/study/nuxt-3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/user/Desktop/study/nuxt-3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
